        ...
        builder: (context, snapshot) {
          ...
          return Column(
            children: [
              ...
              _Bottom(colorIdList: colorIdList, dateList: dateList,focusedDay: focusedDay,),
            ],
          );
        }
      ),
...
List <dailyMood> getMoodList(List<int> colorIdList, List<DateTime> dateList){
  ...
  for (int i = 0 ; i<dateList.length; i++){
    switch(colorIdList[i]){
      case 1: result.add(dailyMood(dateList[i], 'f44336')); break;
      case 2:result.add(dailyMood(dateList[i], 'ff9800')); break;
      case 3:result.add(dailyMood(dateList[i], '4caf50')); break;
      case 4:result.add(dailyMood(dateList[i], '00bcd4')); break;
      case 5:result.add(dailyMood(dateList[i], '536dfe')); break;
      case 6:result.add(dailyMood(dateList[i], 'e91e63')); break;
    }
  }
  return result;
}
...
List<int> getMoodForMonth(List<int> colorIdList, List<DateTime> dateList, DateTime focusedDay){
  List<int> result = [];
